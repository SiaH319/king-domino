...
public class BrowseDominoPileStepDefinition {
    ...
    public void i_provide_a_domino_ID(Integer id) {
        currentDomino = DominoController.getdominoByID(id);
    }


    @Then("the listed domino has {string} left terrain")
    public void the_listed_domino_has_left_terrain(String string) {
        String excepeted = DominoController.getTerrainTypeString(currentDomino.getLeftTile());
    ...
    public void the_listed_domino_has_right_terrain(String string) {
        String excepeted = DominoController.getTerrainTypeString(currentDomino.getRightTile());
        assertEquals(excepeted,string);
    }
    ...
    public void the_listed_domino_has_crowns(Integer int1) {
        Integer excepeted = DominoController.getDominoTotalCrown(currentDomino);
