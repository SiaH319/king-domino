...
public class VerificationController {
     ...
     *
     * @param castle, castle in kingdom
     * @param domino, a domino in kingdom
     * @return true if adjacent to castle, false otherwise
     * @author Cecilia Jiang
     */
    public static boolean verifyCastleAdjacency(Castle castle, DominoInKingdom domino) throws IllegalArgumentException {
        if (castle == null)
     ...
     *
     * @param territories, a list of KingdomTerritory
    ...
    private static boolean noOverlappingWithDomino(Square[] grid, int x, int y) throws IllegalArgumentException{
