...
public class CalculateBonusController {
	...
	if (bonusAmount == 1 && currentGame.getSelectedBonusOption(0).getOptionName().equalsIgnoreCase("middleKingdom")) { 
	...
	//from cecilia, changed a little bit. Checks if grid 5x5 respected as well as if the castle is in the middle
